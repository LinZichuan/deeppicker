...
export LD_LIBRARY_PATH=/data00/Programs/thuempicker_copy_package/softwares/cuda/lib64:$LD_LIBRARY_PATH
...
python train.py --train_type 6 --pos_list "$pos_list" --neg_list "$neg_list" --train_inputDir $extracted_data_dir --train_inputFile '' --particle_number 20000 --model_save_dir $model_save_dir --model_save_file $new_model_name --model_load_file './trained_model/joint-8'
