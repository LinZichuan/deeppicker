...
import re
#NOTE: usage: python showpar_center.py  new/ori  cls
peek_cls = int(sys.argv[2])

#def plot_circle_in_micrograph(micrograph_2d, reference, coordinate, particle_size, filename, color = 'white'):
def plot_circle_in_micrograph(micrograph_2d, coordinate, class_number, particle_size, filename, color = 'white'):
    ...
    while True: 
        ...
        if class_number[i] == peek_cls:
            for win in range(2):
                rr, cc = circle_perimeter(coordinate_x, coordinate_y, radius-win)
...
if __name__ == '__main__':
    if sys.argv[1] == 'ori':
        ...
        new = '_new'
    #mrcpath = '/data00/Programs/thuempicker/relion_zw18_retrain_2Dclass/CtfFind/job003/Micrographs'
    #basepath = '/data00/Programs/thuempicker/relion_zw18_retrain_2Dclass/Class2D/job005/class2Dstar'
    mrcpath = '/data00/Programs/thuempicker/relion_zw18/CtfFind/job012/Micrographs'
    ...
    plot_circle_in_micrograph(body_2d, coordinates, class_number, 180/bin_size, plot, color = 'white')
